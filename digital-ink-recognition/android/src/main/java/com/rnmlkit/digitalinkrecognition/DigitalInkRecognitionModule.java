package com.rnmlkit.digitalinkrecognition;
...
public class DigitalInkRecognitionModule extends ReactContextBaseJavaModule {
    private static final String TAG = "DigitalInkRecognitionModule";
    private final ReactApplicationContext reactContext;
    private DigitalInkRecognizer recognizer;
    private RemoteModelManager remoteModelManager;

    public DigitalInkRecognitionModule(ReactApplicationContext reactContext) {
        super(reactContext);
