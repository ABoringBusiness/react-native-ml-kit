package com.rnmlkit.smartreplies;
...
public class SmartRepliesModule extends ReactContextBaseJavaModule {
    private static final String TAG = "SmartRepliesModule";
    private final ReactApplicationContext reactContext;
    private SmartReplyGenerator smartReplyGenerator;

    public SmartRepliesModule(ReactApplicationContext reactContext) {
        super(reactContext);
